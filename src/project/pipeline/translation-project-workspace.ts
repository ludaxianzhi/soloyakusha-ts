...
export function mergePersistedWorkspaceConfig(
  ...
  return {
    ...
    preProcessorEnabled:
      persisted.preProcessorEnabled ?? current.preProcessorEnabled,
  };
}
...
export function applyWorkspaceConfigPatch(
  ...
  return {
    ...
    preProcessorEnabled:
      patch.preProcessorEnabled === null
        ? undefined
        : (patch.preProcessorEnabled ?? config.preProcessorEnabled),
  };
}
